...
def define_receivers():
    """
    Define my model receivers.
    Don't do this at global scope, as it will get executed when the module
    is loaded, not when the function is called.
    """
