...
import { selectors as schedule_selector, NAME as schedule_name } from '~/modules/schedule'
import { selectors as teams_selector, NAME as teams_name } from '~/modules/teams'

const gsel = {
  ...globalizeSelectors(schedule_selector, schedule_name),
  ...globalizeSelectors(teams_selector, teams_name),
}
