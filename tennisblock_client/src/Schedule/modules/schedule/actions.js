...
export const updateBlockPlayers = createAction(
  types.UPDATE_BLOCK_PLAYERS
)

export const updateBlockPlayersFail = createAction(
  types.UPDATE_BLOCK_PLAYERS_FAILED
)
