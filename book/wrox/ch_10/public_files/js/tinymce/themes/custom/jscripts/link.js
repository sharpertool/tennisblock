...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTML('hrefbrowser','href','file','theme_custom_link');
	...
	addClassesToList('styleSelect', 'theme_custom_link_styles');
...
function insertLink() {
	...
	tinyMCE.themes['custom']._insertLink(href, target, title, dummy, style_class);
	tinyMCEPopup.close();
}
